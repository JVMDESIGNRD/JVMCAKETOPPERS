...
const toppersData = [

    {
        ...
        descripcion: " Topper de Stitch con diseño adorable, ideal para fiestas infantiles y temáticas de Disney.",
   alt: "Stitch Cake Topper" },
    
    {
        ...
        descripcion: "Topper de dragon ball con diseño vibrante, perfecto para cumpleaños temáticos de anime.",
    ...
    },
    {
        ...
        descripcion: "Topper de baby shower con diseño tierno de osito y globos, ideal para celebrar la llegada del bebé.",
        alt: "Baby shower cake topper"
    },
    {
        id: 4,
        nombre: "Topper Masha y el Oso🐻 ",
        img: "img/masha y el oso.png", // imagen local de ejemplo (reemplaza con tu propia imagen)
        descripcion: " Topper de Masha y el Oso con diseño colorido y divertido, ideal para fiestas infantiles.",
    },
    {
        id: 5,
        nombre: "Topper 🦇 Batman 🦸‍♂️",
        img: "img/batman.jpg", // imagen local de ejemplo (reemplaza con tu propia imagen)
        descripcion: "Topper y mascara de Batman con diseño oscuro y elegante, ideal para fiestas temáticas de superhéroes.",
    ...
    },
    {
        ...
        descripcion: "Topper de Batman con diseño oscuro y elegante, ideal para fiestas temáticas de superhéroes.",
        alt: "Batman cake topper"
    },
    {
        id: 7,
        ...
        descripcion: "Topper de Cocomelon con diseño colorido y divertido, ideal para fiestas infantiles.",
    ...
    {
        id: 9,
        nombre: "🌸 A los amantes de las flores, también le personalizamos su topper con sus flores favoritas🌸",
        img: "img/wendotopper.jpeg", // topper similar
        descripcion: "topper para los amantes a las flores con diseño brillante y mágico, ideal para fiestas temáticas.",
    ...
    },
    {
        ...
        descripcion: "Topper de maquillaje con diseño glam, ideal para eventos especiales.",
    ...
    },
    {
        ...
        descripcion: "Topper de la lady bug con diseño colorido y divertido, ideal para fiestas infantiles.",
    ...
    },
    {
        ...
        descripcion: "Topper de Avengers con diseño épico, ideal para fiestas temáticas de superhéroes.",
    ...
    },
    {
        ...
        descripcion: "Topper de Dentista con diseño poderoso, ideal para fiestas temáticas.",
        alt: "Dentista cake topper"
    },
    {
        id: 16,
        nombre: "Topper Heroes en pijama 🦸‍♂️",
        img: "img/HeroeseP.jpg", // imagen local de ejemplo (reemplaza con tu propia imagen)
        descripcion:"Topper de Heroes en pijama con diseño adorable, ideal para fiestas infantiles.",
...
function buildCards() {
    ...
    toppersData.forEach(topper => {
        ...
        cardDiv.addEventListener('click', (e) => {
            ...
            const foundIndex = currentImageList.findIndex(item => item.id === topper.id);
            if (foundIndex !== -1) {
